 ...
 * searching for. Said another way the given CayleyGraph is not a valid counter example.
 * 
...
public class Clique implements java.io.Serializable {
    ...
    /**
     * Class constructor for the Clique. It will initialize the vertex array representing the clique
     ...
     * 
     * @param vertexArrayPosition Integer value of the position of the Vertex within the Clique's
     *        Vertex array.
    ...
    /**
     * This will output a String representing an edge level breakdown of the clique in human
     * readable form.
     * 
