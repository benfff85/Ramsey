...
/**
 * This is the main Controller Class where the program will initiate. It handles the outermost loop of logic which encompasses a framework for the entire application.
 * 
...
public class Controller {
	...
	/**
	 * This is the main method for the application. It will initialize the CayleyGraph object and begin searching for a counter example. A counter example is defined as a CayleyGraph with no clique (complete subgraph) within it. This method will loop continually searching and mutating until a counter example is found.
	 * <p>
	 * It is noted the passing of Strings to methods as done below for the purposes of switch statements is generally poor practice, however it has done here to allow for quick modifications and testing of the code without the use of a GUI.
	 * 
	 * @param args
	 * @return void
	 */
