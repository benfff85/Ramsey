...
public class CliqueChecker {
	...
	/**
	 * This is the main constructor for the CliqueChecker class. It will initialize the necessary global variables. Variables will be sized correctly depending on the the static Config class which dictates the number of elements in the CayleyGraph and the number of elements in the Clique we will be searching for.
	 * 
	 * @param cayleyGraph
	 *            The CayleyGraph object we will be looking for cliques in.
	 */
