...
public class Vertex implements java.io.Serializable {
    ...
    /**
     * This is the constructor class. If will set the ID of the vertex based off of the input as
     * well as initialize an empty array of edges of the size numOfElements.
     * 
    ...
    /**
     * This will add an input Edge to the local array of edges. For now, since this makes the
     * assumption that the Vertex of edges[X] will be X it is advised that this only be used during
     * initialization.
     * 
    ...
    /**
     * This will change the color of an edge between this vertex and another remote vertex defined
     * by the input.
     * 
    ...
    /**
     * This will return the edge which connects this vertex with another remote vertex defined by
     * the input.
     * 
     ...
     * the input.
     * 
     * @param linkedVertexID This is the remote vertex ID used to identify the edge to be returned
     * @return The edge linking this vertex with the remote vertex defined by the input.
     */
    ...
    /**
     * This will return true if all of the edges in the edge array have this.vertexID as one of
     * their vertices. Otherwise it will return false. This will be used for debugging only.
     * 
     * @return This will return a True/False value indicating if all the edges are connected to this
     *         vertex as expected.
     */
