...
/**
 * This Class will help facilitate logging to a file as well as tracking various values to gauge performance and progress.
 * 
...
public class Logger {
	...
	/**
	 * This will take an input String of content and write it to a log file. If the log file is not opened it will open it. All content will append to the end of the file if the file is already opened.
	 * 
	 * @param content
	 *            The String content which will be written to the log file.
	 * @return void
	 */
	...
	/**
	 * This is a local method used to open a new file if the public BufferedWriter is not already opened.
	 * 
	 * @return void
	 */
	...
	/**
	 * Outputs the counter example in the event it has been found. This will write to the log file, email, print to the console and write to a solution file Ramsey.sol. All the above will be in a format compatible with Mathematica with the exception of the .sol file. The .sol file will be comma separated digits so that it may be used as input to the CayleyGraph.loadFromFile method later.
	 * 
	 * @param cg
	 *            The CayleyGraph object the process is being applied to (Counter Example)
	 * @return void
	 */
	...
	/**
	 * This will determine if a checkpoint is required and if so create it. At the moment checkpoints will be created when a CayleyGraph with a new minimum number of cliques is found.
	 * 
	 * @return void
	 */
	...
	/**
	 * This is used to write a basic representation of an input CayleyGraph to a given file which can later be loaded into this program.
	 * 
	 * @param cayleyGraph
	 *            The CayleyGraph to be written to a file.
	 * @param qualifiedFileName
	 *            The file path and name where the CayleyGraph representation is to be written.
	 */
