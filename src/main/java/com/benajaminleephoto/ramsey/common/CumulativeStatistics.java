...
public class CumulativeStatistics {
	 ...
	 * 
	 * @param cg
	 *            Cayley Graph for which statistics are being tracked.
	 */
	...
	/**
	 * This will check the number of cliques found for the current CayleyGraph. If the number of cliques found is a new lowest value than the minCliqueCount values will be updated.
	 */
	 ...
	 * 
	 * @param newAnalyzedGraphCount
	 *            The new value for analyzed graph count.
	 */
	 ...
	 * 
	 * @param cg
	 *            The cayley graph for which statistics are being tracked.
	 */
	 ...
	 * 
	 * @param mcc
	 *            Integer representing the new minimum clique count.
	 */
