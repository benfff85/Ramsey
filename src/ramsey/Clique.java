...
/**
 * This graph represents a clique or complete subgraph identified within a given CayleyGraph. This complete subgraph indicates we cannot raise the lower bound for the 
 * Ramsey Number we are searching for. Said another way the given CayleyGraph is not a valid counter example.
 * 
...
public class Clique {
	...
	/**
	 * This is the main constructor class for the Clique. It will initialize the vertex array representing the clique with the size being defined by the input.
	 *  
	 ...
	 * 
	 * @param vertexArrayPosition Integer value of the position of the Vertex within the Clique's Vertex array.
