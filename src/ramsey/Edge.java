...
public class Edge {
	 ...
	 * 
	 * @param A This is the first Vertex the Edge is connected too. Best practice is to make this the Vertex with the lesser ID.
	 * @param B This is the second Vertex the Edge is connected too. Best practice is to make this the Vertex with the greater ID.
	...
	/**
	 * This will construct and return a human readable string representing the edge. 
